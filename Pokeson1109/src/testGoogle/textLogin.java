...
public class textLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		writer.write("client_id=444437052805-69ml6pka06cockj17ndvuocdnd9dnifg.apps.googleusercontent.com&"); // �o�̽бNxxxx�������ۤv��client_id
		writer.write("client_secret=t9yzi1jsrEU6Sh0rwxTm1yuW&"); // �o�̽бNxxxx�������ۤv��client_serect
		writer.write("redirect_uri=http://localhost:8081/testGoogle/Login.do&"); // �o�̽бNxxxx�������ۤv��redirect_uri
