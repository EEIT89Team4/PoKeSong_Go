...
<div id="page">
	...
	<div>
		...
		<h5>
			...
			value="${detailvo.productClassVO.class_no}" style="color:#0F5DAC">${detailvo.productClassVO.class_name}</a>/${detailname}
			</p>
		</h5>
	</div>
	...
	<div style="margin:auto">
		...
		data-options= "href:'${pageContext.servletContext.contextPath}/detailData?detailno=${classdetailno}&pageNumber=${pageNumber}&pageSize=${pageSize}&order=${ordertype}'">	
		</div>
				    ...
				    onSelectPage:function(pageNumber,changeSize){
				    	if(url.includes("&order=")){
				    		if(pageSize != changeSize){
						    	window.location.assign("${pageContext.servletContext.contextPath}/detailProduct?detailno=${classdetailno}&detail=${detailname}&pageNumber=1&pageSize="+ changeSize +"&order=${ordertype}");
						    	}else{
						    		window.location.assign("${pageContext.servletContext.contextPath}/detailProduct?detailno=${classdetailno}&detail=&{detailname}&pageNumber="+pageNumber+"&pageSize="+pageSize+"&order=${ordertype}");	
						    	}
				    	}else{
					    	if(pageSize != changeSize){
					    	window.location.assign("${pageContext.servletContext.contextPath}/detailProduct?detailno=${classdetailno}&detail=${detailname}&pageNumber=1&pageSize="+ changeSize);
					    	}else{
					    		window.location.assign("${pageContext.servletContext.contextPath}/detailProduct?detailno=${classdetailno}&detail=${detailname}&pageNumber="+pageNumber+"&pageSize="+pageSize);	
					    	}
				    	}
				    },
				});
