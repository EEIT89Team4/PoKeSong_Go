...
<div>
		...
		<div class="row">
			...
			<c:if test="${total==0}">
				<div><h2 style="color:red"> 很抱歉，我們查不到"${searchText}"的相關的商品及資訊。</h2></div>
			</c:if>
				...
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p>
							...
							<input type="button" style="width:100px" name="INSERT" class="btn" id="${product.product_no}" value="追蹤商品">
						</p>
					</div>
				</div>
			</a>
