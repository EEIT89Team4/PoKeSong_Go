		...
		if ("insert".equals(action)) { // 接收addMbr.jsp的資料，新增部分
			...
			try {
				...
				try {
					...
					errorMsgs.put("ErrDateEmpty", "請填生日");
				}
				// 性別不可空白
