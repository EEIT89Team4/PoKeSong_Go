...
@WebServlet("/brandProduct")
public class BrandTransfer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//抓取各種Requset--------------------------------
			...
			//抓取品牌名稱
			String brand = new String (request.getParameter("brand").getBytes(),"UTF-8");
			//抓取分頁
			//預設商品首頁為第1頁
		...
		RequestDispatcher rd = request.getRequestDispatcher("/brandProductPage.jsp");
